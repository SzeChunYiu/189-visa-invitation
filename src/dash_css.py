...
/* every focusable element gets a ring; per-component rules below refine it */
...
.ptlist{margin:0;padding:0;list-style:none;display:flex;flex-direction:column;gap:7px}
.ptlist li{position:relative;padding-left:14px;line-height:1.5}
.ptlist li::before{content:"";position:absolute;left:0;top:.55em;width:5px;height:5px;
  border-radius:50%;background:var(--brand)}
.ptlist li b{color:var(--ink);font-weight:650}
